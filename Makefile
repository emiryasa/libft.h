...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/11/30 19:14:10 by eyasa             #+#    #+#              #
#    Updated: 2023/12/11 20:05:26 by eyasa            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c \
       ...
       ft_strjoin.c  ft_itoa.c ft_toupper.c ft_tolower.c \
	   ft_split.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c \
	   ft_putnbr_fd.c ft_strtrim.c ft_strmapi.c ft_striteri.c 
	   
BONUSSRCS = ft_lstnew_bonus.c ft_lstadd_front_bonus.c \
